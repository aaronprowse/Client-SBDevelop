...
$page_title = "S & B Developments Kent - Services";
    ...
    <section class="content-container container--title">
        <div class="container">
            <div class="col-12 text-center">
                ...
                <p>We offer many services all of which are completed to a very high standard. Please find below the services we provide including examples and testimonials for each service. We also have a quick quotation button, which allows you to get an instant quote for your project. If you cannot find a service that you are looking for then please get in <a href="/contact-us/">contact with us at your local branch</a>.</p>
                <p>We are your home maintenance and refurbishment team in <a href="/coverage/">Kent</a>.</p>
            </div>
        </div>
