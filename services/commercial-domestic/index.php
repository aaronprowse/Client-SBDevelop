...
$page_title = "S & B Developments Kent - Commercial & Domestic";
$page_link = "services";
    ...
    <section class="content-container container--title">
        <div class="container">
            <div class="col-12 text-center">
                ...
                <h1>Commercial / Domestic</h1>
                <p>S&amp;B Developments can provide an extensive range of building services including</p>
                <ul>
                    <li>Home Extensions;</li>
                    <li>Commercial Building Extensions;</li>
                    <li>Building Conversions &ndash; including barn conversions, warehouse conversions etc;</li>
                    <li>House Building (Self-Builds);</li>
                    <li>Flood damage restoration and refurbishment;</li>
                    <li>Fire damage restoration and refurbishment;</li>
                    <li>Building renovation and refurbishments;</li>
