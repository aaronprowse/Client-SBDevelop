...
$page_title = "S & B Developments Kent - Bathrooms";
$page_link = "services";
    ...
    <section class="content-container container--title">
        <div class="container">
            <div class="col-12 text-center">
                ...
                <h1>Bathrooms</h1>
                <p>S&B Developments takes great care in creating a beautiful and efficient space where you can unwind and relax in your bathroom. Our professional designers can take any space and create a bathroom that is modern, clean and finished to a very high standard. We can provide the full design, building work, tiling and flooring for a fully comprehensive build to transform how you use your bathroom.</p>
