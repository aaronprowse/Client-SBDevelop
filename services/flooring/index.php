...
$page_title = "S & B Developments Kent - Flooring";
$page_link = "services";
    ...
    <section class="content-container container--title">
        <div class="container">
            <div class="col-12 text-center">
                ...
                <h1>Flooring</h1>
                <p>We can accommodate for any flooring project no matter the size. We work with some of the best in the industry to ensure a quick turnaround and professional finish. Here at S&B Developments, we provide a wide range of flooring solutions including carpets, tiles and lino flooring. If it is under floor heating you’re after, look no further. We can install all under floor heating so your room is warm during those cold winter months, </p>
