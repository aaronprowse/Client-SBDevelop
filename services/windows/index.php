...
$page_title = "S & B Developments Kent - Windows";
$page_link = "services";
    ...
    <section class="content-container container--title">
        <div class="container">
            <div class="col-12 text-center">
                ...
                <h1>Windows</h1>
                <p>S&B Developments provide a full range of window installation services. We offer a wide range of materials including uPVC, timber and aluminium frames with double or triple glazed glass. The style of the window can be tailored to the building including casement, sash, tilt & turn and dual turn windows. All our work is carried out to the highest standards to ensure the building’s heat efficiency is optimal for all weather.</p>
