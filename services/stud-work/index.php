...
$page_title = "S & B Developments Kent - Stud Work";
$page_link = "services";
    ...
    <section class="content-container container--title">
        <div class="container">
            <div class="col-12 text-center">
                ...
                <h1>Stud Work</h1>
                <p>S&B Developments can cater for any studwork for both commercial and residential projects so you can customise your property to suit your needs. We ensure that all the necessary structural work is carried out to above the legal requirements and given a professional finish. </p>
